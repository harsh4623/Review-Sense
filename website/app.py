...
data = pd.read_csv('/Users/harshpatel/Desktop/PYTHON PROJECT FINAL/Final_Project/website/data/Final_Final.csv')

data1 = pd.read_csv('/Users/harshpatel/Desktop/PYTHON PROJECT FINAL/Final_Project/website/data/Final_updated_Flipkart.csv')
